...
export class AssetClient extends BaseClient{
    ...
    async transfer(from: string, to: string, closeRemainderTo: string | undefined, revocationTarget: string | undefined, amount: number, note: string, assetId: number, rekeyTo: string | undefined): Promise<SendRawTransaction> {
    ...
    async modify(from: string, assetId: number, note: string | undefined, manager: string | undefined, reserve: string | undefined, freeze: string | undefined, clawback: string | undefined, strictEmptyAddressChecking: boolean = false, rekeyTo: string | undefined): Promise<SendRawTransaction> {
    ...
    async destroy(from: string, assetId: number, note: string | undefined, rekeyTo: string | undefined): Promise<SendRawTransaction> {
