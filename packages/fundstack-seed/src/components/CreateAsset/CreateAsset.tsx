...
function CreateAsset(): JSX.Element {
    ...
    const show = poolDetails.action === 'create_asset';
    ...
    async function create() {
        ...
        try {
            ...
            const {txId} = await fSdk.fs.algodesk.assetClient.create(assetParams, note ? note : undefined);
            dispatch(hideLoader());
                ...
                <div className="create-asset-wrapper">
                    <div className="create-asset-container">
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={12} sm={12} md={12} lg={12} xl={12} className="modal-footer-align" style={{textAlign: "center"}}>
