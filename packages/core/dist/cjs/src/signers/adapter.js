...
exports.getSupportedSigners = exports.getSigner = void 0;
...
function getSupportedSigners() {
    return [
        {
            name: constants_1.SIGNERS.ALGO_SIGNER,
            label: 'AlgoSigner',
            instance: getSigner(constants_1.SIGNERS.ALGO_SIGNER),
        ...
        {
            name: constants_1.SIGNERS.MY_ALGO_WALLET,
            label: 'MyAlgo Wallet',
            instance: getSigner(constants_1.SIGNERS.MY_ALGO_WALLET),
...
exports.getSupportedSigners = getSupportedSigners;
