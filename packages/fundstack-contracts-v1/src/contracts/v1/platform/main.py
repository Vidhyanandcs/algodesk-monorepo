...
approvalFile = os.path.join(os.path.dirname(__file__), '..', '..', '..', '..', 'contracts', 'v1', 'platform', 'teal', 'approval.teal')
...
clearFile = os.path.join(os.path.dirname(__file__), '..', '..', '..', '..', 'contracts', 'v1', 'platform', 'teal', 'clear.teal')
if __name__ == "__main__":
